...
#define READBUFFER_MSB	0x69		// bytes per 3-line
#define READBUFFER_LSB	0x0C
#define READBUFFER 		26892		// 3 * 8964  
...
#define MAXOFFSET		(BASEOFFSET + (660*48) - HEIGHT)	// 48 = 4000 / 83   660 = max lines 83 resolution
