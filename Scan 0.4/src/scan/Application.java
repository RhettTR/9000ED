...
public class Application extends JFrame {
    ...
    public Application() {
        ...
        UIManager.put("Desktop.background", Color.decode("#ababab"));
        UIManager.put("InternalFrame.border", BorderFactory.createLineBorder(Color.BLACK, 2));
        UIManager.put("InternalFrame.activeTitleGradient",  gradiantList(Color.WHITE));
        UIManager.put("InternalFrame.inactiveTitleGradient", gradiantList(Color.LIGHT_GRAY));
        
        
        SwingUtilities.updateComponentTreeUI(instance);
        
    
        this.setBounds(400, 40, 1200, 1100);
        ...
        Logger logger = new Logger(getWidth() - 405 - 300, 20, 405, 309);
        desktop.add(logger, BorderLayout.CENTER);

        settings = new Settings(getWidth() - 270 - 20 , 20, 270, 580);
        desktop.add(settings, BorderLayout.EAST);
        ...
        ImageIcon icon = new ImageIcon(getClass().getResource("/scan/images/log.png"));
        button.setIcon(icon);
        ...
        icon = new ImageIcon(getClass().getResource("/scan/images/settings.png"));
        button.setIcon(icon);
        ...
        icon = new ImageIcon(getClass().getResource("/scan/images/nikon.png"));
        ImageIcon disabled = new ImageIcon(getClass().getResource("/scan/images/nikondisabled.png"));
        
        scannerButton.setIcon(icon);
        scannerButton.setDisabledIcon(disabled);
    ...
    private ArrayList gradiantList(Color c) {
