...
#define MAIN_MSB			0x00
#define MAIN_LSB			0x01
#define SUB_MSB				0x00
#define SUB_LSB				0x00
...
int set(int color, uint32_t exposure)
{
	...
	parameter_buffer[WINDOW_HEADER+2] = 0x00 | 0x0F;		// 4000=0FA0
	...
	parameter_buffer[WINDOW_HEADER+17] = 0x00 | 0x04;	// 
														// 8964*3*2 = 53784 bytes pr. line
														
	parameter_buffer[WINDOW_HEADER+18] = 0x00;		// Window Length (Y)
	parameter_buffer[WINDOW_HEADER+19] = 0x00;	
	parameter_buffer[WINDOW_HEADER+20] = 0x00 | 0x23;	// 8964 lines																
	parameter_buffer[WINDOW_HEADER+21] = 0x00 | 0x04;	// 53784*8964 = 482 119 776 bytes total
	...
	parameter_buffer[WINDOW_HEADER+44] = 0x00 | 0x02;		// 0x40 		3-line
...
#define READBUFFER_MSB	0xD2		// bytes per line
#define READBUFFER_LSB	0x18
#define READBUFFER 		53784		// 
...
void readData()
{
	...
	// 512 * 1024 * 1024 = 536 870 912 bytes  >  482 119 776 
	...
	write_ptr = fopen("../tmp/Scan.bin", "wb");  // w for write, b for binary
